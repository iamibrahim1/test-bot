...
let v = await ke.json()
	...
	listSections.push([++index + ' ' + cmenub + '📍Location: ' + v.country, [
          ['Style: A', usedPrefix + command + ' nice https://api.mapbox.com/styles/v1/mapbox/dark-v10/static/pin-l-embassy+f74e4e(' + lon + ',' + lat + ')/' + lon + ',' + lat + ',16/500x300?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', v.alpha2],
['Style: B', usedPrefix + command + ' nice https://api.mapbox.com/styles/v1/mapbox/light-v10/static/pin-s-l+000(' + lon + ',' + lat + ')/' + lon + ',' + lat + ',14/500x300?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', v.alpha2],
['Style: C', usedPrefix + command + ' nice https://api.mapbox.com/styles/v1/mapbox/light-v10/static/url-https%3A%2F%2Fdocs.mapbox.com%2Fapi%2Fimg%2Fcustom-marker.png(' + lon + ',' + lat + ')/' + lon + ',' + lat + ',15/500x300?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', v.alpha2],
['Style: D', usedPrefix + command + ' nice https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/' + lon + ',' + lat + ',0,60/400x400?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', v.alpha2],
...
['Style: F', usedPrefix + command + ' nice https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/geojson(%7B%22type%22%3A%22Point%22%2C%22coordinates%22%3A%5B' + lon + '%2C' + lat + '%5D%7D)/' + lon + ',' + lat + ',12/500x300?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', v.alpha2],
